...
def my_slider_handler(attr,old,new):
    ...
    min_n=parameters.data['Min_n']
    min_meters=parameters.data['Min_meters']
    
    
    from bokeh.models.widgets import DataTable, DateFormatter, TableColumn
    
    source.data=dict(
            values=[percent[0],min_n[0],min_meters[0]],
            parameters=['percent','min_n','min_meters'],)
    ...
    print(percent[0],min_n[0],min_meters[0])
...
#print(percent,min_n,min_meters)
