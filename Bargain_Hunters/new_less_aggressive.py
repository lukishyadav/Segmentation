...
UL=(Q3 + 1.5 * IQR)
LL=(Q1 - 1.5 * IQR)
DF_F2 = DATA[~((DD < (Q1 - 1.5 * IQR)) |(DD > (Q3 + 1.5 * IQR))).any(axis=1)]
...
UL=(Q3 + 1.5 * IQR)
LL=(Q1 - 1.5 * IQR)
DF_F3= DATA[~((DD < (Q1 - 1.5 * IQR)) |(DD > (Q3 + 1.5 * IQR))).any(axis=1)]
print('IQR:',IQR,'Q1:',Q1,'Q3:',Q3,'UL',(Q3 + 1.5 * IQR))
"""


m,n,a,s,d,c2p=my_module.outlier(data,'Coupon_to_pocket') 
m,n,a,s,d,fare=my_module.outlier(data,'Fare') 


import seaborn as sns
sns.boxplot(c2p['Coupon_to_pocket'])
