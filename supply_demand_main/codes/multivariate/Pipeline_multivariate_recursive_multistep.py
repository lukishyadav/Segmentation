...
maxtemp_c,mintemp_c,avgtemp_c,maxwind_kph,avgvis_km
...
def see_unseen(lag,series,P_value,metric,foreca):
    ...
    lstm_model,h,H=fit_lstm_main2000(train_scaled,test_scaled, 1, 500, 100,100,'val_loss')
...
if P!=0:
    ...
    see_unseen(lag,series,P,metric,foreca)
