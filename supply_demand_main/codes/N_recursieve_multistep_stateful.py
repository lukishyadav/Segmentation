...
df=pd.read_csv('/Users/lukishyadav/Desktop/Segmentation/supply_demand_main/data_big/data/quadrant_0/timescale_90/hex_edge_0.51m_quantile_0_hourly.csv')
...
if P==0:
 ...
 buffer=list(DATA.tail(3).values.reshape(1,3)[0])
 for x in range(N):
