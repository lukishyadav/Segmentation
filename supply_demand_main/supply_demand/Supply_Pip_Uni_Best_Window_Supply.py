...
dfs=pd.read_csv('/Users/lukishyadav/Desktop/Segmentation/supply_demand_main/supply/darwin_rentals_time_loc_data_20180701_20190701_breakdown/quadrant_0/timescale_30/hex_edge_461.355m_all_hexes_hourly.csv')

CL=df.columns
df=pd.merge(df['timeseries'],dfs[CL],on='timeseries',how='inner')
